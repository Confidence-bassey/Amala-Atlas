import React from 'react'; // also fix the lowercase 'react'
...
const cardData = [
  ...
  },
  {
    title: "Open for All",
    icon: (
      <svg className="w-8 h-8 text-purple-500 mb-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        <circle cx="12" cy="12" r="10" />
        <path d="M8 12h8" />
      </svg>
    ),
